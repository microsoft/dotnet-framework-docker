...
def isPR = true
def platformList = [
        'Windows_2016:WindowsServerCore-ltsc2016',
        'Windows_2016:WindowsServerCore-1709',
        'Windows_2016:WindowsServerCore-1803'
        //'Windows_2016:WindowsServerCore-ltsc2019'
    ]
...
platformList.each { platform ->
    ...
    versionList.each { version ->
        ...
        if (containerOS == 'WindowsServerCore-ltsc2019') {
            newJob.with {label('windows.10.amd64.serverrs5.open')}
        }
        else if (containerOS == 'WindowsServerCore-1803') {
