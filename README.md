...
* [.NET Framework Console Docker Sample](samples/dotnetapp/README.md) - This [sample](samples/dotnetapp/Dockerfile) builds, tests, and runs the sample. It includes and builds multiple projects.
* [ASP.NET Web Forms Docker Sample](samples/aspnetapp/README.md) - This [sample](samples/aspnetapp/Dockerfile) demonstrates using Docker with an ASP.NET Web Forms app.
* [ASP.NET MVC Docker Sample](samples/aspnetmvcapp/README.md) - This [sample](samples/aspnetmvcapp/Dockerfile) demonstrates using Docker with an ASP.NET MVC app.
