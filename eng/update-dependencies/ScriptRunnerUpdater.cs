...
namespace Microsoft.DotNet.Framework.UpdateDependencies
{
    ...
    public class ScriptRunnerUpdater : IDependencyUpdater
    {
        ...
        public static IDependencyUpdater GetDockerfileUpdater(string repoRoot) =>
            new ScriptRunnerUpdater(Path.Combine(repoRoot, "eng", "dockerfile-templates", "Get-GeneratedDockerfiles.ps1"));

        public static IDependencyUpdater GetReadMeUpdater(string repoRoot) =>
            new ScriptRunnerUpdater(Path.Combine(repoRoot, "eng", "readme-templates", "Get-GeneratedReadmes.ps1"));
