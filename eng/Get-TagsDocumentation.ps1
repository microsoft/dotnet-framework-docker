...
& $PSScriptRoot/common/Invoke-ReadmeGeneration.ps1 dotnet/framework/aspnet README.aspnet.md manifest.aspnet.json master $gitRepo -ReuseImageBuilderImage
& $PSScriptRoot/common/Invoke-ReadmeGeneration.ps1 dotnet/framework/wcf README.wcf.md manifest.wcf.json master $gitRepo -ReuseImageBuilderImage
