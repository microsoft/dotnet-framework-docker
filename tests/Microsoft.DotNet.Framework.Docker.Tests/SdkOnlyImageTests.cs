...
namespace Microsoft.DotNet.Framework.Docker.Tests
{
    ...
    public class SdkOnlyImageTests : ImageTests
    {
        ...
        public static IEnumerable<object[]> GetImageData() =>
            ImageTestHelper.ApplyImageDataFilters(TestData.GetImageData(), "sdk");

        private static bool IsSkippable(ImageDescriptor imageDescriptor) =>
            imageDescriptor.Version == "4.6.2" ||
            imageDescriptor.Version == "4.7" ||
            imageDescriptor.Version == "4.7.1" ||
            imageDescriptor.Version == "4.7.2";
