...
namespace Microsoft.DotNet.Framework.Docker.Tests
{
    public class RuntimeImageTests
    {
        private static RuntimeImageDescriptor[] RuntimeTestData = new RuntimeImageDescriptor[]
        {
            ...
            new RuntimeImageDescriptor { Version = "4.7", SdkVersion = "4.7.2", OsVariant = OsVersion.WSC_LTSC2016 },
            new RuntimeImageDescriptor { Version = "4.7.1", SdkVersion = "4.7.1", OsVariant = OsVersion.WSC_LTSC2016 },
            new RuntimeImageDescriptor { Version = "4.7.2", SdkVersion = "4.7.2", OsVariant = OsVersion.WSC_LTSC2016 },
            new RuntimeImageDescriptor { Version = "4.7.2", SdkVersion = "4.7.2", OsVariant = OsVersion.WSC_1803 },
            new RuntimeImageDescriptor { Version = "4.7.2", SdkVersion = "4.7.2", OsVariant = OsVersion.WSC_LTSC2019 },
